...
```{r}
# Utilization plot with pizzas sold
...
ggsave("base_model_utilization_metrics_with_pizzas.png", width = 10, height = 6, dpi = 300)

# Idle time plot with pizzas sold
ggplot(metrics_df, aes(x = period, group = 1)) +
...
# store the plot as image
ggsave("base_model_idle_metrics_with_pizzas.png", width = 10, height = 6, dpi = 300)
```

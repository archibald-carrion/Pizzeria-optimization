...
```{r}
# Utilization plot with chef count
ggplot(metrics_df, aes(x = period, group = 1)) +
  ...
  scale_y_continuous(sec.axis = sec_axis(~., name = "Number of Chefs")) +
  labs(title = "System Utilization and Chef Staffing",
       x = "Time Period",
       y = "Utilization Rate") +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
  scale_fill_manual(values = c("Chefs" = "blue", "Oven" = "red")) +
  scale_color_manual(values = c("Num Chefs" = "green"))

# store the plot as image
ggsave("optimized_utilization_plot.png")
```